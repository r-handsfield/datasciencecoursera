...
<p>Use the Lissajous app at __ to compare different pairs of sine functions. Move the sliders to change each function's frequency, then view the resulting Lissajous curve</p>

<img src="assets/fig/lissajous_shiny_app.png" title="lissajous app screenshot" alt="lissajous app screenshot" style="display: block; margin: auto;" /></p>