...
```
__Description__
The dataset reports _The Effect of Vitamin C on Tooth Growth in Guinea Pigs_ in 3 columns, _tooth length_, _supplement type_, and _dose (mg)_.
...
g <- g + facet_grid(.~supp) + xlab("Dose (mg)")
g
```
