...
The actual interval is always some multiple $K$ of the standard error, where $K$ is the number of standard deviations corresponding to the quantile of whatever confidence level you want. Ex. $95\% \sim 1.96$, $90\% \sim~ 1.65$, $etc.$  
...
# the confidence interval in feet
