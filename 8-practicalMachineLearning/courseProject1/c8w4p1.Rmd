...
for (iter in 1:52) {
	...
	# log training time
	validation_curves[iter, "trnTime"] <- (Sys.time() - begin)
	...
	validation_curves[iter, 2:6] <- modRf$finalModel$confusion[,6]
	...
	validation_curves[iter, 7:11] <- (1 - cmTmp$byClass[,1])
	print("\n\n==============================================\n\n")
}
stopCluster(cl)
# add the number of features for easy plotting
validation_curves$numFeatures <- 1:52
```
