...
Answer: panel.lmline()
#Also abline, refline, curve, rug, average, linejoin, fill, grid, mathdensity
...
I am interested in examining how the relationship between ozone and 
wind speed varies across each month. What would be the appropriate 
